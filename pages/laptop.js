                                ...
                                products.map((product) => {
                                    return <div key={product.slug} className="lg:w-1/4 md:w-1/2 w-full p-4">
                                        <Link href={`/product/${product.slug}`}>
                                            <div className="bg-white flex flex-col transition-all duration-300 ease-in-out justify-between  rounded-2xl cursor-pointer w-full hover:shadow-xl hover:shadow-yellow-300 h-full">
